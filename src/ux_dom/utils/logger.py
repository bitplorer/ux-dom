...
"""ux_dom_logger — library logging facade for CLI and runtime messages."""
import logging
import sys
...
ux_dom_logger = logging.getLogger("ux-dom")
...
stdout_info.addFilter(DuplicateMessageFilter("ux-dom"))

ux_dom_logger.addHandler(stdout_info)
