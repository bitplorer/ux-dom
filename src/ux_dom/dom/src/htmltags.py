...
"""Concrete HTML tag classes bound to Tags MRO (div, span, input, ...).

Imported via ux_dom.dom. Attribute cleaning: Tags.clean_attribute.
"""
...
if __name__ == "__main__":
    from ux_dom.dom.src.utils.dom_util import dom_text
