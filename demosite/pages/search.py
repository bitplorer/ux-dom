        ...
        return template(
            div(
                div(
                    ...
                    "items-center p-0.1 pb-1.5 text-zinc-400 fill-current",
                ),
                input_(
                    name="search_query",
                    type="text",
                ...
                div(
                    ...
                    "z-10 absolute -left-0.1 top-10 bg-stone-200/40 "
                    "m-0.1 mr-1 backdrop-blur-sm p-2 md:dark:bg-stone-600/10 ",
            ...
            with div(
                ...
                with div(className="flex h-full w-full"):
                    div(
                        ...
                        "bg-stone-400/40 m-0.1 p-2 md:dark:bg-stone-600/10 "
