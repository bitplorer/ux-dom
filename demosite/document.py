...
from ux_dom.dom import link, raw, script
...
document = Document(
    ...
    body=[
        ...
        # custom-elements — single runtime name (x_element.js), no dual component.js
        script(
            src=f"/js/{x_element_js().save(file_or_dir=settings.webassets.static.js / 'x_element.js')}"
        ),
        # Chart JS
        script(
